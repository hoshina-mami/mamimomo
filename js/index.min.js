...
var i;return ie.isWindow(t)?t.document.documentElement["client"+e]:9===t.nodeType?(i=t.documentElement,Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var on=e.jQuery,an=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=an),t&&e.jQuery===ie&&(e.jQuery=on),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),(function(){var a;document.addEventListener("DOMContentLoaded",function(){a=$(".list_works").find("li");var c=$("#jsMenuNews"),d=$("#jsMenuContact");c.on("click",function(){$(this).next().slideToggle("fast");$(this).toggleClass("active")});d.on("click",function(){$(this).next().slideToggle("fast");$(this).toggleClass("active")});$("#js_all").on("click",function(){$(".nav").removeClass("on");$("#js_all").addClass("on");b("all")});$("#js_app").on("click",function(){$(".nav").removeClass("on");$("#js_app").addClass("on");b("app")});$("#js_stamp").on("click",function(){$(".nav").removeClass("on");$("#js_stamp").addClass("on");b("stamp")});$("#js_skin").on("click",function(){$(".nav").removeClass("on");$("#js_skin").addClass("on");b("skin")})});var b=function(c){var d=$(".list_works");d.addClass("hide").empty();switch(c){case"all":d.append(a).removeClass("hide");break;case"app":d.append(a);$(".work_stamp").remove();$(".work_skin").remove();d.removeClass("hide");break;case"stamp":d.append(a);$(".work_app").remove();$(".work_skin").remove();d.removeClass("hide");break;case"skin":d.append(a);$(".work_app").remove();$(".work_stamp").remove();d.removeClass("hide");break}}})();